        ...
        try
        {
            ...
            {//bone
                ...
                if (ConvertArmatuar)
                {
                    ...
                    var grooveId = hips.BoneId - 1;
                    var groove = new PmxBoneData()
                    {
                        BoneName = "センター",
                        BoneNameE = "center",
                        BoneId = grooveId,
                        ParentId = 0,
                        Pos = new Vector3(0, neck.Pos.y * 0.6f, 0),
                        Flag = BoneFlags.VISIBLE | BoneFlags.ROTATE | BoneFlags.OP | BoneFlags.MOVE,
                        PosOffset = new Vector3(0, -neck.Pos.y * 0.6f, 0),
                    };
                    ...
                    insertBone(bonesList, groove, grooveId);
...

                    {
                        ...
                        var eyes = new PmxBoneData()
                        {
                            ...
                            Pos = new Vector3(0, head.Pos.y * 1.2f, 0),
                            ParentId = head.BoneId,
                            Flag = BoneFlags.VISIBLE | BoneFlags.ROTATE | BoneFlags.OP,
                            PosOffset = new Vector3(0, 0, -0.5f),
                        };
